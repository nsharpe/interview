...
include(":user-management:user-management-endpoint-webapp")
include(":user-management:user-management-endpoint-sdk")
include(":user-management:user-management-endpoint-typescript-sdk")

include(":media-management")
include(":media-management:media-management-webapp")
