...
public class UserController {
    ...
    public Mono<UserModel> create(@Validated @RequestBody Mono<CreateUserModel> userModel){
    ...
    @Operation(summary = "Modify a User",
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", description = "User not found")})
    @PutMapping("/user/{id}")
    public Mono<UserModel> modify(@PathVariable("id")UUID id, @Validated @RequestBody Mono<UpdateUserModel> userModel){
