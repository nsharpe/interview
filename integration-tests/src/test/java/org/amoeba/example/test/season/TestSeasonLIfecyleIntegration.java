package org.amoeba.example.test.season;
...
import org.amoeba.example.test.data.SeasonGenerator;
import org.amoeba.example.test.data.SeriesGenerator;
...
import static org.amoeba.example.test.data.PostPayloadGenerator.createSeasonPojo;
